...
metadata_file = "/content/colors_pca.xlsx"
...
def plot_pca(pca_data, pve, pc1=1, pc2=2):
    ...
    # Define colors for each location group - keeping original colors and adding new ones
    location_colors = {
        # Original colors (kept the same)
        'Iowa': '#1f77b4',
        'Kansas': '#ff7f0e',
        'Nebraska North': '#2ca02c',
        'Nebraska South': '#d62728',
        'Nebraska': '#2ca02c',  # In case North/South isn't available

        # New state colors - using a diverse palette
        'Michigan': '#9467bd',
        'Wisconsin': '#8c564b',
        'Virginia': '#e377c2',
        'South Carolina': '#7f7f7f',
        'Maine': '#bcbd22',
        'Alabama': '#17becf',
        'Florida': '#ff9896',
        'North Carolina': '#98df8a',
        'Tennessee': '#c5b0d5',
        'Texas': '#ffbb78',
        'Minnesota': '#c49c94',
        'Oklahoma': '#f7b6d3',
