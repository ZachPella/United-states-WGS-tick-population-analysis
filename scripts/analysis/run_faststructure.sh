...
OUTDIR=${WORKING_DIR}/faststructure_results_maf01_miss20
INPUT_FILE=${WORKING_DIR}/filtered.iscap_fauver61andonline_gatksplitintervals10_snps_basefilt.maf01.miss20.mac2.bi.vcf.gz.LD_pruned.vcf.str.cleaned_header_and_6_dummy
