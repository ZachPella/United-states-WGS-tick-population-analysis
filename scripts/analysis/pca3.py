...
def plot_pca(pca_data, pve, pc1=1, pc2=2):
    ...
    # --- UPDATED: Define color and style mappings based on user request ---
    
    # Define which states belong to each category
    ...
    for group in present_groups:
        ...
        if not group_data.empty:
            ...
            # Determine color, marker edge color, and fill based on the group
            if group == 'Nebraska North':
                color = '#0000FF'  # Blue
                edgecolors = 'black'
            elif group == 'Nebraska South':
                color = '#FF0000'  # Red
                edgecolors = 'black'
            elif group in midwest_east_states:
                color = 'black'
                edgecolors = 'black'
            elif group in southern_states:
                color = 'white'
                edgecolors = 'black'
            else: # Fallback for any unassigned states
                color = 'gray'
                edgecolors = 'black'
