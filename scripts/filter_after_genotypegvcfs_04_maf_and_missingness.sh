...
INPUT_VCF=${WORKDIR}/cohort_combined_193samples_snps_only_variant_filtered_passed_column_only_final.vcf.gz
OUTPUT_VCF_PREFIX=cohort_combined_193samples_snps_only_variant_filtered_passed_column_only_maf_and_missingness_final.vcf.gz
