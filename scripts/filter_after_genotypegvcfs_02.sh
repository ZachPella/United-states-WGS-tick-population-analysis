...
INPUT_SNP_VCF="${BASEDIR}/genotyping/cohort_combined_193samples_snps_only_final.vcf.gz"
OUTPUT_FILTERED_VCF="${BASEDIR}/genotyping/cohort_combined_193samples_snps_only_variant_filtered_final.vcf.gz"
