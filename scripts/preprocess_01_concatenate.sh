...
OUTPUT_DIR="/work/fauverlab/zachpella/scripts_ticksJune2025/concatenated_fastq"
SAMPLE_LIST="/work/fauverlab/zachpella/scripts_ticksJune2025/sample_list.txt"
