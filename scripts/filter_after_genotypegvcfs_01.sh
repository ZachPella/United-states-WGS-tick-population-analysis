...
INPUT_VCF="${BASEDIR}/genotyping/cohort_combined_193samples_final.vcf.gz"
OUTPUT_SNP_VCF="${BASEDIR}/genotyping/cohort_combined_193samples_snps_only_final.vcf.gz"
